...
/** Mounted once in the root layout: marks `[data-reveal]` elements with
 *  `data-in` as they enter the viewport, which triggers the CSS fade-in. One
 *  observer serves the whole site, including content added after navigation. */
